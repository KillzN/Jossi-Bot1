/**
𝐉𝐎𝐒𝐒𝐈 𝐁𝐎𝐓 @ineffable.mvrco - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '56983073328-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝐉𝐎𝐒𝐒𝐈 𝐁𝐎𝐓', 'jpegThumbnail': null } } };
