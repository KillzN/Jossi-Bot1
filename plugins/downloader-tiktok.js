...
import {tiktokdl} from '@josssi_bot.ff';
...
import('@xct007/frieren-scraper')
  ...
  .catch((error) => {
    console.error('SIGUEME AL INSTAGRAM @josssi_bot.ff".');
  });
...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'ᴛʜᴇ ᴍʏsᴛɪᴄ - ʙᴏᴛ', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/KillzN/Jossi-Bot1'}, mentionedJid: [m.sender]}}}, aa);
